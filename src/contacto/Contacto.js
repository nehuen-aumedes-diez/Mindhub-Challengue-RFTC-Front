...
<div class="wrapper">
    ...
    <div class="company-info">
        ...
        <div className="iconos-contacto">
           <a> <img src="./gmail.png" width={'50px'}></img></a>
            <a><img src="./gorjeo.png" width={'50px'}></img></a>
            <a><img src="./instagram.png" width={'50px'}></img></a> 
          <a>  <img src="./facebook.png" width={'50px'}></img></a>
        </div>
    </div>
