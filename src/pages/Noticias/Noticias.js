        ...
        <div className="noticias-cuerpo">
            ...
            <figure className="noticia-carta2">
                ...
                <div className="capa-noticia2">
                    ...
                    <button className="notiButt">Lee más...</button>
                </div>
            </figure>
            <figure className="noticia-carta2">
                <div className="capa-noticia2">
                ...
                <div className="capa-noticia">
                    <h3>Firman convenios con clubes de fútbol para promover la inclusión de personas con discapacidad</h3>
                    <p>El director de la Agencia Nacional de Discapacidad, Fernando Galarraga, aseguró que ya se firmaron acuerdos con Boca, San Lorenzo, Estudiantes, Racing, Atlanta y Vélez para para "promover el acceso y la inclusión deportiva" dentro de estas instituciones.</p>
            ...
            <figure className="noticia-carta">
                ...
                <div className="capa-noticia">
                    <h3>¿Qué países han ganado más Mundiales de fútbol?</h3>
                    <p>Mirá la lista histórica de campeones.</p>
                    <button>Lee más...</button>
                </div>
            </figure>
            <figure className="noticia-carta">
                ...
                <div className="capa-noticia">
                    <h3>“Elijo creer”</h3>
                    <p>Arden las redes sociales con nuevas coincidencias virales para predecir el resultado de la final del Mundial.</p>
                    <button>Lee más...</button>
                </div>
            </figure>
            <figure className="noticia-carta">
                ...
                <div className="capa-noticia">
                    <h3>Argentina – Francia: el historial entre los finalistas del Mundial de Qatar 2022</h3>
                    <p>A lo largo de la historia, los equipos disputaron 12 partidos entre ellos: seis culminaron en victoria para Argentina, tres fueron para Francia y los tres restantes resultaron en empate.</p>
                    <button>Lee más...</button>
                </div>
            </figure>       
        </div>
