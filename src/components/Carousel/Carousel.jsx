          ...
          <div className="cards__wrapper">
            <div className="card current--card">
              <div className="card__image">
                <img
                  src="https://cdn.shopify.com/s/files/1/0015/5841/3357/products/MODEL-NUMBER-10-ARGENTINA_2000x.jpg?v=1627401514"
                  alt=""
                />
              </div>
            </div>
            <div className="card next--card">
              <div className="card__image">
                <img
                  src="https://cdn.shopify.com/s/files/1/0015/5841/3357/products/PERCHAS-ARGENTINA-WOMEN-SOL_550x.png?v=1627407437"
                  alt=""
                />
              </div>
            </div>
            <div className="card previous--card">
              <div className="card__image">
                <img
                  src="https://cdn.shopify.com/s/files/1/0015/5841/3357/collections/MODEL-HOODIE-DIABLO_180x.png?v=1571518856%20180w%20180h"
                  alt=""
                />
              </div>
            </div>
        ...
        <div className="infoList">
          <div className="info__wrapper">
            <div className="info current--info">
              ...
              <button className="text">Hola</button>
            </div>
